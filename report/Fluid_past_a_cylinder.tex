...
\newcommand{\firstcoadvisor}{Doct. Michele Bucelli} % insert if any otherwise comment
% -> academic year
...
\begin{figure}[h]
    ...
    % Row 1: velocity
    \subfloat[Velocity (Coarse) \label{fig:2d_1_coarse_velocity}]{\includegraphics[width=\gridwidth]{Images/Test_cases/2D/Test_1/Screenshots/Coarse/t_5_velocity.png}} 
    \hfill
    \subfloat[Velocity (Fine) \label{fig:2d_1_fine_velocity}]{\includegraphics[width=\gridwidth]{Images/Test_cases/2D/Test_1/Screenshots/Fine/t_5_velocity.png}} \\
    
    % Row 2: Pressure
    \subfloat[Pressure (Coarse) \label{fig:2d_1_coarse_pressure}]{\includegraphics[width=\gridwidth]{Images/Test_cases/2D/Test_1/Screenshots/Coarse/t_5_pressure.png}} 
    \hfill
    \subfloat[Pressure (Fine) \label{fig:2d_1_fine_pressure}]{\includegraphics[width=\gridwidth]{Images/Test_cases/2D/Test_1/Screenshots/Fine/t_5_pressure.png}} \\
...
\begin{figure}[h]
    ...
    % Row 1: velocity
    \subfloat[Velocity (Coarse) \label{fig:2d_2_coarse_velocity}]{\includegraphics[width=\gridwidth]{Images/Test_cases/2D/Test_2/Screenshots/Coarse/t_5_velocity.png}} 
    \hfill
    \subfloat[Velocity (Fine) \label{fig:2d_2_fine_velocity}]{\includegraphics[width=\gridwidth]{Images/Test_cases/2D/Test_2/Screenshots/Fine/t_5_velocity.png}} \\
    
    % Row 2: Pressure
    \subfloat[Pressure (Coarse) \label{fig:2d_2_coarse_pressure}]{\includegraphics[width=\gridwidth]{Images/Test_cases/2D/Test_2/Screenshots/Coarse/t_5_pressure.png}} 
    \hfill
    \subfloat[Pressure (Fine) \label{fig:2d_2_fine_pressure}]{\includegraphics[width=\gridwidth]{Images/Test_cases/2D/Test_2/Screenshots/Fine/t_5_pressure.png}} \\
...
\begin{figure}[p]
    ...
    \subfloat[Cylinder Velocity (Coarse) \label{fig:3d_1_cylinder_coarse_velocity}]{\includegraphics[width=\gridwidth]{t_4_cylinder_coarse_velocity.png}} 
    \hfill
    \subfloat[Cylinder Velocity (Fine) \label{fig:3d_1_cylinder_fine_velocity}]{\includegraphics[width=\gridwidth]{t_4_cylinder_fine_velocity.png}} \\
    
    % Row 2: Cylinder Pressure
    \subfloat[Cylinder Pressure (Coarse) \label{fig:3d_1_cylinder_coarse_pressure}]{\includegraphics[width=\gridwidth]{t_4_cylinder_coarse_pressure.png}} 
    \hfill
    \subfloat[Cylinder Pressure (Fine) \label{fig:3d_1_cylinder_fine_pressure}]{\includegraphics[width=\gridwidth]{t_4_cylinder_fine_pressure.png}} \\
    
    % Row 3: Parallelepiped Velocity
    \subfloat[Parallelepiped Velocity (Coarse)  \label{fig:3d_1_parallelepiped_coarse_velocity}]{\includegraphics[width=\gridwidth]{t_4_parallelepiped_coarse_velocity.png}} 
    \hfill
    \subfloat[Parallelepiped Velocity (Fine) \label{fig:3d_1_parallelepiped_fine_velocity}]{\includegraphics[width=\gridwidth]{t_4_parallelepiped_fine_velocity.png}} \\
    
    % Row 4: Parallelepiped Pressure
    \subfloat[Parallelepiped Pressure (Coarse) \label{fig:3d_1_parallelepiped_coarse_pressure}]{\includegraphics[width=\gridwidth]{t_4_parallelepiped_coarse_pressure.png}} 
    \hfill
    \subfloat[Parallelepiped Pressure (Fine)\label{fig:3d_1_parallelepiped_fine_pressure}]{\includegraphics[width=\gridwidth]{Images/Test_cases/3D/Test_1/Screenshots/t_4_parallelepiped_fine_pressure.png}}
...
\begin{figure}[p]
    ...
    % Row 1: Cylinder Velocity
    \subfloat[Cylinder Velocity (Fine)]{\includegraphics[width=\gridwidth]{glyph_test2_fine.png}} 
    \hfill
    \subfloat[Cylinder Pressure (Fine)]{\includegraphics[width=\gridwidth]{pres_test2_cyl.png}} \\

    \subfloat[Cylinder Velocity (Fine)]{\includegraphics[width=\gridwidth]{vel_test2_cyl.png}} 
    \hfill
    \subfloat[Cylinder Pressure (Coarse)]{\includegraphics[width=\gridwidth]{pres_test2_coarse.png}}

    \subfloat[Cylinder Velocity (Coarse)]{\includegraphics[width=\gridwidth]{glyph_cyl_test2.png}} 
    \hfill
    \subfloat[Cylinder Velocity (Coarse)]{\includegraphics[width=\gridwidth]{vel_test2_coarse.png}}
...
\begin{figure}[p]
    ...
    \subfloat[Cylinder Glyph (Fine)]{\includegraphics[width=\gridwidth]{vel_glyph_test3.png}}
    \hfill
    \subfloat[Cylinder Pressure (Fine)]{\includegraphics[width=\gridwidth]{pre_cyl_test3.png}} 

    \subfloat[Cylinder Stream Tracer (Coarse)]{\includegraphics[width=\gridwidth]{cyl_st_coarse.png}}
    \hfill
    \subfloat[Cylinder Stream Tracer (Fine)]{\includegraphics[width=\gridwidth]{vel_st_test3.png}}


    \hfill
    \subfloat[Parallelepiped Velocity (Fine)]{\includegraphics[width=\gridwidth]{par_test3_coarse.png}}
    \hfill
    \subfloat[Parallelepiped Pressure (Coarse)]{\includegraphics[width=\gridwidth]{par_test3_pressure.png}}

    \hfill
    \subfloat[Parallelepiped Stream Tracer (Fine)]{\includegraphics[width=\gridwidth]{par_test3_st.png}}
    \hfill
    \subfloat[Parallelepiped Pressure (Fine)]{\includegraphics[width=\gridwidth]{pressure_fine.png}}
...
\begin{figure}[p]
    ...
    % Row 1: velocity
    \subfloat[Velocity \label{fig:ct_velocity}]{\includegraphics[width=\gridwidth]{Images/Test_cases/2D/Re_1000_CT/Screenshots/t_5_velocity.png}} 
    \hfill
    \subfloat[Pressure \label{fig:ct_pressure}]{\includegraphics[width=\gridwidth]{Images/Test_cases/2D/Re_1000_CT/Screenshots/t_5_pressure.png}} \\

...
namespace NavierStokes{
	 ...
	 */
	template<int dim>
	void NonStationaryNavierStokes<dim>::setup_dofs()
	{
	...
	template <int dim>
	void NonStationaryNavierStokes<dim>::assemble_system(const bool initial_step)
	{
		assemble(initial_step, true);
	}
	
	template <int dim>
	void NonStationaryNavierStokes<dim>::assemble_rhs(const bool initial_step)
	{
